...
void ASTrackerBot::SelfDestruct()
{
	...
	if (GetLocalRole() == ROLE_Authority)
	{
		...
		const float Damage = ExplosionDamage + (ExplosionDamage * PowerLevel);

		UGameplayStatics::ApplyRadialDamage(this, Damage, GetActorLocation(), ExplosionRadius,
...
void ASTrackerBot::OnCheckNearbyBots()
{
	...
	if (MatInst)
	{
		const float Alpha = PowerLevel / (float) MaxPowerLevel;
